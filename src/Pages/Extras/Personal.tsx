...
export function Personal() {
  ...
  return (
    <>
      <div className="Personal">
        <div className="Section Watches">
          ...
          <ul>
            <li>
              <a
                href="https://www.chrono24.com/seiko/ref-sbxy089.htm"
                target="_blank"
              >
                Seiko Astron Nexter "Starry Sky
              </a>
            </li>
            <li>
              <a
                href="https://www.chrono24.com/seiko/ref-ssk039j1.htm"
                target="_blank"
              >
            ...
            <li>
              <a
                href="https://www.chrono24.com/seiko/ref-sary095.htm"
                target="_blank"
              >
                Seiko Presage Mechanical Open Heart
              </a>
            </li>
            <li>
              <a
                href="https://www.chrono24.com/swatch/mission-to-mars--imod3133.htm"
                target="_blank"
              >
            ...
            <li>
              <a
                href="https://www.tissotwatches.com/en-us/T1372071109101.html?srsltid=AfmBOoqaS-DqbEdVjoWBoHly-CiO5AZHab67AkVMeYcsGP1fwokAXXc2"
                target="_blank"
              >
                Tissot PRX 35MM
              </a>
            ...
            <li>
              <a
                href="https://www.watchoutz.com/products/seiko-x-monster-hunter-20th-anniversary-project-collaboration-mizutsune-limited-edition-quartz-chronograph?srsltid=AfmBOorTLwGVmLsWWZ2S3AmqqohMOvzSe47Gv10lij4RGkMNqetpHSeo"
                target="_blank"
              >
                Seiko X Monster Hunter "Mizutsune"
              </a>
            </li>
          </ul>
        </div>
      ...
      {/*This is where I add my websites as I make more.*/}
      <div className="Section Websites">
        <h3>Web Apps I've built</h3>
        <div className="Website-Container">
          {/*Copy this Site-Link div and change the anchor and 
          iframe elements as needed*/}
          <div className="Site-Link">
            <a
              href="https://dishsoapbrew.vercel.app"
              target="_blank"
            ...
            <iframe
              src="https://dishsoapbrew.vercel.app"
              title="Brewery Search App"
            />
          </div>
          {/*More Websites would go here*/}
        </div>
      </div>
      <div className="Section Gallery">
        ...
        <div className="Images-Container">
          <a
            href="https://youtu.be/WdbRb2ksX7s?si=cC-XgkEeVYCLdRZ6"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
